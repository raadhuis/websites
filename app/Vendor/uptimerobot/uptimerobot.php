...
class UptimeRobot
{
     ...
     *
     */
    public function getMonitors($monitors = null, $customUptimeRatio = null, $logs = 1, $responseTimes = 1, $responseTimesAverage = 0, $alertContacts = 0, $showMonitorAlertContacts = 0, $showTimezone = 0, $search = "")
    {
