...
<head>
	...
	<style type="text/css">
		...
		/* Reset Styles */
		body{margin:0; padding:0;background-color: #f4e8f2}
		img{border:0; height:auto; line-height:100%; outline:none; text-decoration:none;}
		table td{border-collapse:collapse;}
		#backgroundTable{height:100% !important; margin:0; padding:0; width:100% !important;background-color: #f4e8f2}
...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" bgcolor="#f4e8f2">
<center>
			...
			<td align="center" valign="top">
				...
				<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateContainer">
					...
					<tr>
						<td align="center" valign="top">
							<!-- // Begin Template Body \\ -->
							<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateBody" bgcolor="white">
								<tr>
					...
					<tr>
						<td align="center" valign="top" bgcolor="#F4E8F2" style="background-color:#F4E8F2">
